document.addEventListener('DOMContentLoaded', () => {
    ...
    const lyrics = [
        { time: 0, text: "Sayang.." },
        { time: 2, text: "Perjalan kita kan berlayar" },
        { time: 7, text: "Berlabuh di tujuan yang sama" },
        { time: 12, text: "Bermuara di keabadian" },
        { time: 17, text: "Ahh.." },
        { time: 20, text: "Sayang.." },
        { time: 22, text: "Perjalanan kita kan berlayar" },
        { time: 27, text: "Berlabuh di tujuan yang sama" },
        { time: 32, text: "Tenang.." },
        { time: 37, text: "Peluk tempatku" },
        { time: 42, text: "Pulang.." },
        { time: 47, text: "....." },
    ];
